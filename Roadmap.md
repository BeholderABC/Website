...
- [ ] 改进[在线作业组件](docs/.vitepress/theme/components/ProblemGroup.vue)，提供更清晰更友好的交互（尤其是禁用知识相关）
- [ ] 常见问题汇总
- [ ] 心得体会分享
  - [ x ] 提问的智慧
  - [ x ] 如何利用生成式 AI
...
- [ ] 嵌入 [Monaca Editor](https://github.com/microsoft/monaco-editor)，作为一系列在线工具的基础

  - [ ] 在线格式检查/违规检查

  > [工具](https://github.com/Maoyao233/tjhlp-checker)已经有现成的基础，简单包装 API 然后前端写对照规则即可。但提供这个是否对学习有利；如果提供，是否限制配额（如每题不超过2次）

  - [ ] 代码数据/质量分析

  > 常态化、进阶版 linecount，除了代码行数还可以动态分析、对比一些其他指标，如圈复杂度、自我重复程度等

- [ ] 在线/离线评测：仿照 CodeForces 模式，使用 pretest 与 system test 两个环节，给学习更强的正反馈（？）；或者仿照 CS61A 提供离线评测的客户端
